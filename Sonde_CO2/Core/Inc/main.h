...
/* Private defines -----------------------------------------------------------*/
#define CO2_PWR_Pin GPIO_PIN_14
#define CO2_PWR_GPIO_Port GPIOC
#define Screen_CS_Pin GPIO_PIN_15
#define Screen_CS_GPIO_Port GPIOC
#define Screen_PWR_Pin GPIO_PIN_1
#define Screen_PWR_GPIO_Port GPIOA
#define SD_PWR_Pin GPIO_PIN_2
#define SD_PWR_GPIO_Port GPIOA
#define SD_CS_Pin GPIO_PIN_3
#define SD_CS_GPIO_Port GPIOA
#define Screen_Busy_Pin GPIO_PIN_4
